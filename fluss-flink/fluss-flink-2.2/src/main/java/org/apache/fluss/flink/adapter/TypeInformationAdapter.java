 ...
 *
 * <p>In Flink 2.2, {@link TypeInformation} declares {@code createSerializer(SerializerConfig)} as
 ...
 *
 * <p>When building for Flink 2.2, this class is used instead of the common adapter so that the
