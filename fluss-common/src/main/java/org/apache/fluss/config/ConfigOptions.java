...
public class ConfigOptions {
    ...
    public static final ConfigOption<Double> TABLE_AUTO_INC_PREFETCH_LOW_WATER_MARK_RATIO =
            key("table.auto-inc-low-water-level-mark-size-ratio")
                    .doubleType()
                    .defaultValue(0.3)
                    .withDescription(
    ...
    public static final ConfigOption<Long> TABLE_AUTO_INC_PREFETCH_BATCH_SIZE =
            key("table.auto-inc-prefetch-batch-size")
                    .longType()
                    .defaultValue(100000L)
                    .withDescription("The auto increment column IDs prefetch batch size.");
